...
function InvoiceDbPreview() {
  ...
  return <main style={{ maxWidth: 1100, margin: '24px auto', padding: '0 20px', display: 'grid', gap: 18 }}>
    ...
    <InvoiceLedgerDetail data={{ units: displayUnits, recipientName: names, projectName: () => 'サンプル発電所', plannedAmount: () => null,
      recipients:[{id:1,name:'顧客A'},{id:2,name:'顧客B'}] }} projectId={1}
