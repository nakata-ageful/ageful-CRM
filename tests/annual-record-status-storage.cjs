...
const { toStoredAnnualRecordStatus: convert, annualRecordPayloadForStorage: adapt } = scope.exports
...
console.log('PASS: storage adapter maps only legacy blank, preserves known statuses and omitted status, rejects invalid values. Not connected to live save paths.')
